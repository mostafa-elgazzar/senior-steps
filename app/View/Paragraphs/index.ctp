<div class="paragraphs index">
	...
	<tr>
		...
		<td><?php echo h($paragraph['Paragraph']['title']); ?>&nbsp;</td>
		<td><?php echo h($paragraph['Paragraph']['body']); ?>&nbsp;</td>
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $paragraph['Paragraph']['id']), array('confirm' => __('Are you sure you want to delete # %s?', $paragraph['Paragraph']['id']))); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
